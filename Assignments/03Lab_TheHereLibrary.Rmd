...
author: "Environmental Data Analytics | John Fay and Luana Lima | Updated by Andrea Bruns"
date: "Spring 2024"
output: pdf_document
...
# 2.
epa.air.files <- dir(here("Data", "Raw"), pattern = ("EPAair_O3*"))
epa.air.files
epa.air <- epa.air.files %>%
  map(read_csv) %>%
  reduce(rbind)
epa.air
```
