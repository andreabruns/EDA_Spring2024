...
```{r DataExercise-1a}
highs <- c(50, 52, 47, 55, 55, 55, 54, 54, 55, 58)
lows <- c(42, 42, 45, 43, 44, 44, 43, 43, 45, 46)
...
```{r DataExercise-1c}
colnames <- c("highs F", "highs C", "lows F", "lows C")
temps <- data.frame(highs, highC, lows, lowC)
names(temps) <- colnames
temps
```
